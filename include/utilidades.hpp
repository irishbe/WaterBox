...
string generarIDConFormato(int numero, int longitud) {
...
void imprimirOpcionesFlechas(string titulo, string subtitulo, vector<string> opciones, bool centrar, int indiceSeleccionado) {
    ...
    moverCursor(10, y + numeroOpciones + 3);
    cout << "Presione ESC o 0 para cancelar" << endl;
}

// Función para la selección con flechas
string seleccionarConFlechas(vector<string> opciones, string titulo, string subtitulo = "", bool centrar = true) {
    char tecla;
    int index = 0;
